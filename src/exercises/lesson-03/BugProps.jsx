...
//The message was stored in a plain variable Reactdoesn't track,
// so reassigning it didnt trigger any changes when the button is
//  pressed, moving it into useState lets react watch it and update the UI when the button is clicked.
